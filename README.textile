...
<pre>RAILS_ROOT/app/templates/layouts/your-layout-name.radius</pre>
...
<pre>rake radiant:extensions:file_system_resources:extract layouts=layout1,layout2,etc</pre>
